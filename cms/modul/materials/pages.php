...
<table width="100%" border="0" id="tbl_obj" class="draggedTable">
  <tr>
    ...
    <th style="text-align:left; width:220px">Ссылка</th>
	...
	do
	{
		...
		echo "
		  <tr $display num='$myrow[number]' id='$myrow[id]' >
			...
			<td><input name='hr' type='text' value='http://$_SERVER[HTTP_HOST]/pages/$myrow[id]/$m_link/' style='width:100%'></td>
			<td>$user</td>
			<td>$myrow[date]</td>
...
<div class="oboznach">
	<img src="img/disabled.png" height="12">  Материал неактивен <img src="img/enabled.png" height="12">  Материал активен
</div>