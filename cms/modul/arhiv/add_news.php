    ...
    <div id="center_contayner">
        ...
        <div class="block2 block_contayner">
            ...
            <br>
				...
				if (isset($_GET[id]))
				{
						$folder_img = "modul/news/upload/files/$_GET[id]/";
						@$dir    = "modul/news/upload/files/$_GET[id]/";
						...
						for ($i=0;$i<=30;$i++)
						{
							if ($files_img[$i]!='' && $files_img[$i]!='.' && $files_img[$i]!='..' && $files_img[$i]!="Thumbs.db") 
							{
									...
									<a href='modul/news/upload/files/$_GET[id]/$files_img[$i]' style='display:inline-block; color:#333' target='_blank'>$files_img[$i]</a></div>";		
							}
						} 
				}
                ?>            
