...
<form action="modul/galery/obr_galery_cat.php" method="post" enctype="multipart/form-data" name="form_news">
<?
	if (isset($_GET[id]))
	{
...
<div id="main_inf_block">
    <div id="menu_center">
        <a href="#" class="name_link1 menu_center_a_enabl name_link" style="margin-left:0px" num='1'>Папка: </a>
    ...
    <div id="center_contayner">
              ...
              <tr>
                <td style="width:150px">
                	<?
                    	if ($myrow[img]!='')
						{
							$img = "modul/galery/upload/img/$myrow[img]";
						}
						else
						{
							$img = "img/no_img.jpg";
        ...
        <div class="block2 block_contayner">
            ...
            <br>
				...
				if (isset($_GET[id]))
				{
						$folder_img = "modul/galery/upload/files/$_GET[id]/";
						@$dir    = "modul/galery/upload/files/$_GET[id]/";
						...
						for ($i=0;$i<=30;$i++)
						{
							...
							{
									echo "<div num='div$i'>
									<a href='#' style='display:inline-block; color:red; margin-right:5px; text-decoration:none' class='popop del_file' num='upload/files/$_GET[id]/$files_img[$i]' value='div$i'>X</a>
									<a href='modul/galery/upload/files/$_GET[id]/$files_img[$i]' style='display:inline-block; color:#333' target='_blank'>$files_img[$i]</a></div>";		
							}
						} 
				}
                ?>            
        ...
        <div class="block3 block_contayner">
            Выберите форму из списка и она будет прикреплена к папке галереи:
            <br>
        ...
        <div class="block4 block_contayner"><?  $host='galery_cat'; include("blocks/key_desc.php"); ?></div>
        
        <div style="text-align:right">
            <a href="?page=galery" class="button_cancel">Отмена</a> 
