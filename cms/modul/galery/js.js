$(document).ready(function() {
	...
	$(".del_file").click(function() {
		...
		$.post("modul/galery/ajax_delfile.php",
		  {
	...
	$(".del_news1").click(function() {
		$("#msgBox_del").fadeIn();
		$(".button_yes").attr("href","modul/galery/obr_galery_cat.php?del="+$(this).attr("num"));
		
	});
	
	$(".button_enabl").click(function() {
		$.post("modul/galery/ajax.php",
		  {
			num: $(this).attr("num"),
			id: $(this).attr("value")
		  }
	 ...
	 $(".draggedTable").tableDnD({
		 onDrop: function(table, row) {
			...
			for (j=1; j<i; j++)
			{
				...
				$.post("modul/galery/ajax_drag.php",
				  {
					this_e: this_e,
					last_e: last_e,
					next_e: next_e,
	...
	$(".del_img_galery").click(function() {
		$("#msgBox_del").fadeIn();
		$(".button_yes").attr("href","modul/galery/obr_add_img.php?del="+$(this).attr("num"));
