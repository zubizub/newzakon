...
if ($p=="materials" || $p=="add_folder_materials" || $p=="news" || $p=="vopros_inf" || $p=="vopros" || $p=="galery" || $p == "add_pages" || $p=="fmanager" || $p=="formmanager" || $p=="add_news" || $p=="add_galery_cat" || $p=="galery_img" || $p=="zadaniy" || $p=="zadaniy_inf") 
...
if ($p=="zayvki" || $p=="obr_svyz_inf" || $p=="doc" || $p=='zayvka_inf' || $p=="obr_svyz" || $p=="users" || $p=="comment" || $p=="vopros_otvet" || $p=="otziv" || $p=="rassilka" && $_COOKIE[close_left_menu]==1) 
...
<div style="width:173px; position:relative; <? echo $d; ?> padding:5px; float:right" class='div2_left2 dop_podmenu'>
    <div class="menu1 pod_link_left">
        ...
        <a href="?page=vopros" <? if ($p=="vopros" || $p=="vopros_inf") {echo "class='now_page'";} ?>>Вопросы</a>
        <a href="?page=market_moderation" <? if ($p=="market_moderation" || $p=="market_moderation") {echo "class='now_page'";} ?>>Модерация маркета</a>
...
<div style="width:173px; position:relative; <? echo $d4; ?> padding:5px; float:right" class='div2_left5 dop_podmenu'>
    <div class="menu1 pod_link_left">
        ...
        <a href="?page=doc" <? if ($p=="doc") {echo "class='now_page'";} ?>>Документы</a>
