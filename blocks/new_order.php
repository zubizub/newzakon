        ...
        <form action="#" method="post" name="frmNewZadanie" class="frmNewZadanie" enctype="multipart/form-data">
        	...
        	<div class="innerFrmNewZadanie">
                ...
                <select name="type" class="vidTask">
                    ...
                    $result_u = mysql_query("SELECT * FROM type_uslugi WHERE enabl='0' ORDER BY name ASC");
                    ...
                    if ($num_rows_u!=0)
                    {
                    	do
                    	{
                            ...
                            /*if (!$_GET['folder']) {
                                ...
                                if ($i==0) {
                                    echo "<option selected>Другое</option>";
                                }
                                $i++;
            ...
            <div class="innerFrmNewZadanie">
                <div class="frmNewZadanie-name">Категория</div>
                        ...
                        $result_cat = mysql_query("SELECT * FROM pages WHERE m_link = '".$_GET['name']."'");
                         ...
                         $result_cat = mysql_query("SELECT * FROM folder_materials WHERE id = '".$_GET['id']."'");   
                        }
                ...
                <select name="cat" class="typeCatUsluga">
                    <? echo '<option selected="">'.$myrow_cat[name].'</option>'; ?>
