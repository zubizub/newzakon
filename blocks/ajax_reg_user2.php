...
if ($type==2)
{
    ...
    else
    {
        ...
        $result_add = mysql_query ("INSERT INTO users (uid,name,pass,phone,mail,fio,date_reg,status,text,real_pass,podtverjdenie,mail_enabl2) VALUES ('$uid','$phone','$pass','$phone','','Пользователь','$date','Пользователь','-','$real_pass','1','1')");
